...
public class main {
    public static void main(String[] args) {
        ...
        Alumno alumno1 = new Alumno("Facundo", "Sabelli", 5);
        Profesor profesor1 = new Profesor("tomas", "Fedi");
        Platos plato1 = new Platos("fideos", 100);
        Platos plato2 = new Platos("choclo", 50);
        Pedidos pedidos1 = new Pedidos("1Enero", 1, false, alumno1, plato1);
        Pedidos pedidos2 = new Pedidos("2Enero", 2, false, profesor1, plato2);
